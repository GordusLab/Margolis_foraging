% This code takes experimental and model data from the output of Model_20023.m 
...
D_Exp_Traceidx = dsearchn(trace_coord,[20,0.1]);%19, 0
...
saveas(gcf,'Experimental Traces','svg')
...
histogram(OUTPUT.Exp_Slopes(1,:) - OUTPUT.Exp_Slopes(2,:),edges,'FaceColor','b','Normalization','probability');
hold on

% Change in Slope Histogram - Model
histogram(OUTPUT.Model_Slopes(1,:) - OUTPUT.Model_Slopes(2,:),edges,'FaceColor','r','Normalization','probability');
hold on
...
histogram(OUTPUT.Time(OUTPUT.Exp_Inflection),edges,'FaceColor','b','Normalization','probability');
hold on


% Inflection Points Histogram - Model
histogram(OUTPUT.Time(OUTPUT.Model_Inflection),edges,'FaceColor','r','Normalization','probability');
